...
const VerifyEmail: React.FC<FormInput> = ({
  email,
  name,
  password,
  confirmPassword,
  ...
  return (
    <>
      <div className="flex items-center justify-center  bg-white p-2">
        <div className="flex flex-col gap-4 w-3/5 p-10 bg-white rounded-lg shadow-lg overflow-hidden">
          ...
          <form>
            <div className="mb-4">
              ...
              <div className="mb-4 text-center text-black font-thin">
                You can request to
                <button
                  className="text-blue-800 font-extrabold ml-3 mr-3"
                ...
                in
                <div className="text-blue-800 font-extrabold">{`0:${
